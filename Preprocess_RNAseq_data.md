...
vim ./arabidopsis_thaliana/scripts/snakemake/Preprocess_RNAseq_data/config.yaml
#triticum aestivum
vim ./triticum_aestivum/scripts/snakemake/Preprocess_RNAseq_data/config.yaml
...
- [RNAseq_quality_control](#rnaseq_quality_control)
  ...
  - [Multiqc](#multiqc)
- [RNAseq_mapping_reads_to_genome](#rnaseq-mapping-reads-to-genome)
...
- [RNAseq_extract_expression_data](#rnaseq_extract_expression_data)
- [RNAseq_cluster_analysis](#rnaseq_cluster_analysis)
- [RNAseq_PCA_analysis](#rnaseq_pca_analysis)
...
## RNAseq mapping reads to genome
...
## RNAseq_extract_expression_data
