...
vim ./arabidopsis_thaliana/scripts/snakemake/Joint_analysis/config.yaml
#triticum aestivum
vim ./triticum_aestivum/scripts/snakemake/Joint_analysis/config.yaml 
...
- Update `geneanno_bed` for different species (e.g., `reference/geneanno/gencode.v44.annotation.bed` for human , `reference/geneanno/Arabidopsis_thaliana.TAIR10.62.bed` for arabidopsis, `Triticum_aestivum.IWGSC.62.bed` for triticum)
...
- Update `jaspar_raw` and `jaspar_dir` for arabidopsis (e.g., `datasets/JASPAR2026_CORE_plants_non-redundant_pfms_meme.txt` and `datasets/JASPAR2026_CORE` )
...
- [Analysis_of_the_enhancer_region](#analysis-of-the-enhancer-region)
    ...
    - [Get_shared_Down_Enhancer_and_shared_Down_gene](#get_shared_down_enhancer_and_shared_down_gene)
