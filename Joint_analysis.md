...
#plant
vim ./plant/scripts/snakemake/Joint_analysis/config.yaml  
...
- Update `geneanno_bed` for different species (e.g., `reference/geneanno/gencode.v44.annotation.bed` for human , `reference/geneanno/Arabidopsis_thaliana.TAIR10.62.bed` for plant)
...
- Update `jaspar_raw` and `jaspar_dir` for plant (e.g., `datasets/JASPAR2026_CORE_plants_non-redundant_pfms_meme.txt` and `datasets/JASPAR2026_CORE` )
