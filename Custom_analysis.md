...
vim ./arabidopsis_thaliana/scripts/snakemake/Custom_genes_analysis/config.yaml 
#triticum aestivum
vim ./triticum_aestivum/scripts/snakemake/Custom_genes_analysis/config.yaml
...
- Update `jaspar_dir` for plant (e.g., `datasets/JASPAR2026_CORE` )
- Update `tf_mapping_file` for different species (e.g.`datasets/Homo_sapiens_TF.txt` for human , `datasets/Ath_TF_list.txt` for arabidopsis , `datasets/Tae_TF_list.txt` for triticum)
...
#arabidopsis thaliana
mkdir -p ./arabidopsis_thaliana/datasets/Custom_genes_analysis
vim ./arabidopsis_thaliana/datasets/Custom_genes_analysis/custom_genes.txt

#triticum aestivum
mkdir -p ./triticum_aestivum/datasets/Custom_genes_analysis
vim ./triticum_aestivum/datasets/Custom_genes_analysis/custom_genes.txt
```
...
## **List of processes**
- [Convert_gene_ID](#convert_customgene_to_ensemlid)
- [Enrichment_analysis](#gsea_enrichment)
- [Regulatory_analysis](#extr_promoterseq)
  - [Extract_custom_genes_promoterSeq](#extr_promoterseq)
  - [Motif_enrich](#motif_enrich)
  - [Constructe_TF_Gene_network](#tf_gene_network)
  - [Extract_enriched_motifs](#extract_enriched_motifs)
  - [Plot_TF_heatmap](#tf_heatmap)
