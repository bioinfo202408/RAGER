...
rule all:
    input:
        ...
        f"{config['paths']['dir']}/custom_gene_gsea_GOenrich.rds",
        f"{config['paths']['dir']}/custom_gene_gsea_KEGGenrich.rds",
...
rule GSEA_enrichment:
    ...
    output:
        ...
        GOrds=f"{config['paths']['dir']}/custom_gene_gsea_GOenrich.rds",
        KEGGrds=f"{config['paths']['dir']}/custom_gene_gsea_KEGGenrich.rds"
    shell:
        """
