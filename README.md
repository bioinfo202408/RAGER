...
3. If you are analyzing Arabidopsis thaliana data,navigate to the `PROJECT/RAGER/plant` folder.

```bash
cd ~/PROJECT/RAGER/plant
#Download and unzip reference genome
...
4. If you are analyzing your own reference genome (custom gene fragments), navigate to the corresponding species folder and build indexes.
